...
source "/home/sten/Uni/HardwareArchitecturesforAI/Lab4/neuron_FP/solution1/syn/verilog/neuron_ap_fmul_1_max_dsp_32_ip.tcl"
if {[regexp -nocase {2015\.3.*} $vivado_ver match] || [regexp -nocase {2016\.1.*} $vivado_ver match]} {
    extract_files -base_dir "./prjsrcs/sources_1/ip" [get_files -all -of [get_ips neuron_ap_fmul_1_max_dsp_32]]
}
source "/home/sten/Uni/HardwareArchitecturesforAI/Lab4/neuron_FP/solution1/syn/verilog/neuron_ap_fadd_2_full_dsp_32_ip.tcl"
if {[regexp -nocase {2015\.3.*} $vivado_ver match] || [regexp -nocase {2016\.1.*} $vivado_ver match]} {
