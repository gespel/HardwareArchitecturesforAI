...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.neuron.autotvin_w_fxp_V.dat"
         "c.neuron.autotvin_x_fxp_V.dat"
         "c.neuron.autotvin_b_fxp_V.dat"
         "c.neuron.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.neuron.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
