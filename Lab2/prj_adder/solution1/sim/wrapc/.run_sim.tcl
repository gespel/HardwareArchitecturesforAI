...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "adder.autotvin.dat"
	set constFileTvOut       "adder.autotvout.dat"
	set constFileHdlTvIn     "adder.autohdltvin.dat"
	set constFileHdlTvOut    "adder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
