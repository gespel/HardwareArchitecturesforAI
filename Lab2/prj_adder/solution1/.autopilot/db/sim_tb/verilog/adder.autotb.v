...
`define AUTOTB_TVIN_c  "./c.adder.autotvin_c.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.adder.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.adder.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.adder.autotvin_c.dat"
`define AUTOTB_TVOUT_ap_return  "./c.adder.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.adder.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.adder.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.adder.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.adder.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.adder.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.adder.autotvout_ap_return.dat with impl_rtl.adder.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
