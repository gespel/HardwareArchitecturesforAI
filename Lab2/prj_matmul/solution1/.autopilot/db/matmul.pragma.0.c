...
# 1 "/home/sten/vivado/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 305 "/home/sten/vivado/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
void matrix_vector_mult(int mat[3][3], int vec[3], int result[3]) {_ssdm_SpecArrayDimSize(mat, 3);_ssdm_SpecArrayDimSize(vec, 3);_ssdm_SpecArrayDimSize(result, 3);
    for(int i = 0; i < 3; i++) {
        result[i] = 0;
        for(int j = 0; j < 3; j++) {
