...
`define AUTOTB_TVIN_mat  "./c.matrix_vector_mult.autotvin_mat.dat"
`define AUTOTB_TVIN_vec  "./c.matrix_vector_mult.autotvin_vec.dat"
`define AUTOTB_TVIN_result  "./c.matrix_vector_mult.autotvin_result.dat"
`define AUTOTB_TVIN_mat_out_wrapc  "./rtl.matrix_vector_mult.autotvin_mat.dat"
`define AUTOTB_TVIN_vec_out_wrapc  "./rtl.matrix_vector_mult.autotvin_vec.dat"
`define AUTOTB_TVIN_result_out_wrapc  "./rtl.matrix_vector_mult.autotvin_result.dat"
`define AUTOTB_TVOUT_result  "./c.matrix_vector_mult.autotvout_result.dat"
`define AUTOTB_TVOUT_result_out_wrapc  "./impl_rtl.matrix_vector_mult.autotvout_result.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.matrix_vector_mult.autotvout_result.dat", "r");
    fp2 = $fopen("./impl_rtl.matrix_vector_mult.autotvout_result.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matrix_vector_mult.autotvout_result.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matrix_vector_mult.autotvout_result.dat\"!");
    else begin
        $display("Comparing rtl.matrix_vector_mult.autotvout_result.dat with impl_rtl.matrix_vector_mult.autotvout_result.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
