...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrix_vector_mult.autotvin_mat.dat"
         "c.matrix_vector_mult.autotvin_vec.dat"
         "c.matrix_vector_mult.autotvin_result.dat"
         "c.matrix_vector_mult.autotvout_result.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrix_vector_mult.autotvout_result.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
