...
if {[file isfile matrix_vector_mult.autotvin.dat]} {
	file delete -force matrix_vector_mult.autotvin.dat
}

if {[file isfile matrix_vector_mult.autotvout.dat]} {
	file delete -force matrix_vector_mult.autotvout.dat
}
