...
`define AUTOTB_DUT      mlp
`define AUTOTB_DUT_INST AESL_inst_mlp
`define AUTOTB_TOP      apatb_mlp_top
`define AUTOTB_LAT_RESULT_FILE "mlp.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mlp.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mlp_top
...
`define AUTOTB_TVIN_input_V  "./c.mlp.autotvin_input_V.dat"
`define AUTOTB_TVIN_output_r  "./c.mlp.autotvin_output_r.dat"
`define AUTOTB_TVIN_input_V_out_wrapc  "./rtl.mlp.autotvin_input_V.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "./rtl.mlp.autotvin_output_r.dat"
`define AUTOTB_TVOUT_output_r  "./c.mlp.autotvout_output_r.dat"
`define AUTOTB_TVOUT_output_r_out_wrapc  "./impl_rtl.mlp.autotvout_output_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 5;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 8645;
parameter LENGTH_input_V = 784;
...
wire    [9 : 0]    arrayinput_V_address0, arrayinput_V_address1;
wire    [19 : 0]    arrayinput_V_din0, arrayinput_V_din1;
wire    [19 : 0]    arrayinput_V_dout0, arrayinput_V_dout1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.mlp.autotvout_output_r.dat", "r");
    fp2 = $fopen("./impl_rtl.mlp.autotvout_output_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mlp.autotvout_output_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mlp.autotvout_output_r.dat\"!");
    else begin
        $display("Comparing rtl.mlp.autotvout_output_r.dat with impl_rtl.mlp.autotvout_output_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
