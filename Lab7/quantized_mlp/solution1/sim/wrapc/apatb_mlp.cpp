...
#define AUTOTB_TVIN_input_V  "../tv/cdatafile/c.mlp.autotvin_input_V.dat"
// wrapc file define: "output_r"
#define AUTOTB_TVIN_output_r  "../tv/cdatafile/c.mlp.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r  "../tv/cdatafile/c.mlp.autotvout_output_r.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "output_r"
#define AUTOTB_TVOUT_PC_output_r  "../tv/rtldatafile/rtl.mlp.autotvout_output_r.dat"
...
extern void mlp (
const ap_fixed<20, 6, (ap_q_mode) 5, (ap_o_mode)3, 0> input[784],
float output[10]);
...
float output[10])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *output_r_pc_buffer = new sc_bv<32>[10];
			int i = 0;
					...
					// bitslice(31, 0)
					{
						...
						// celement: output(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 9; i_0 += 1)
							{
								...
								{
									output_lv0_0_9_1[hls_map_index].range(31, 0) = sc_bv<32>(output_r_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<20>* input_V_tvin_wrapc_buffer = new sc_bv<20>[784];
			...
			// bitslice(19, 0)
			{
				...
				// celement: input.V(19, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 783; i_0 += 1)
					{
						...
						// input_type_conversion : (input[i_0]).range().to_string(SC_BIN).c_str()
						if (&(input[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<20> input_V_tmp_mem;
							input_V_tmp_mem = (input[i_0]).range().to_string(SC_BIN).c_str();
							input_V_tvin_wrapc_buffer[hls_map_index].range(19, 0) = input_V_tmp_mem.range(19, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		tcl_file.set_num(784, &tcl_file.input_V_depth);
		...
		sc_bv<32>* output_r_tvin_wrapc_buffer = new sc_bv<32>[10];
		...
		tcl_file.set_num(10, &tcl_file.output_r_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* output_r_tvout_wrapc_buffer = new sc_bv<32>[10];
