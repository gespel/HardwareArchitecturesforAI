...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mlp.autotvin.dat"
	set constFileTvOut       "mlp.autotvout.dat"
	set constFileHdlTvIn     "mlp.autohdltvin.dat"
	set constFileHdlTvOut    "mlp.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
