...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(mlp_B4_V_ram) {
        ram[0] = "0b111111000000";
        ram[1] = "0b001100000000";
        ram[2] = "0b110111000000";
        ram[3] = "0b000010000000";
        ram[4] = "0b001001100000";
        ram[5] = "0b001001100000";
        ram[6] = "0b111110100000";
        ram[7] = "0b000111100000";
        ram[8] = "0b101100000000";
        ram[9] = "0b111110000000";
