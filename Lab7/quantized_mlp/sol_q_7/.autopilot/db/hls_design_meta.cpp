...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_V_q0", 20, hls_in, 0, "ap_memory", "mem_dout", 1),
	Port_Property("output_r_address0", 4, hls_out, 1, "ap_memory", "mem_address", 1),
	...
	Port_Property("output_r_q0", 32, hls_in, 1, "ap_memory", "mem_dout", 1),
};
